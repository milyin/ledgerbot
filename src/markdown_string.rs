...
mod tests {
    ...
    fn test_markdown_format_macro_complex() {
        let template = MarkdownString::test_template(
            "*User:* {} \n*Amount:* ${} \n*Category:* `{}`"
        );
        let user = "Alice";
        let amount = 100.50;
    ...
    fn test_markdown_format_macro_multiple_same_placeholder() {
        ...
        assert_eq!(result.as_str(), "Hello Bob\\*\\! Nice to meet you, Bob\\*\\.");
    }
    ...
    fn test_markdown_format_with_escaped_template() {
        ...
        assert_eq!(result.as_str(), "Hello\\! This is safe content: \\*bold\\* \\_italic\\_");
    }
    ...
    fn test_markdown_format_with_into_trait() {
        ...
        assert_eq!(result3.as_str(), "Safe user content with \\*special\\* chars");
